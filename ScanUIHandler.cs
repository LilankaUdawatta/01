...
// startup.
public class ScanUIHandler : MonoBehaviour {
    ...
    public GameObject SignInandSignUp;
	//public GameObject NoInternetLogin, NoInternetSignUp, NoInternetScan;
    public GameObject NoInternetScan;
	//public GameObject InternetFoundLogin, InternetFoundSignUp, InternetFoundScan;
    public GameObject InternetFoundScan;
	...
	protected virtual void Update() {
		...
		if (Application.internetReachability != NetworkReachability.NotReachable && noInternetBanner == true)
		{
			InternetFound();
			Debug.Log("Internet Connection Found");
		}

		else if (Application.internetReachability == NetworkReachability.NotReachable && noInternetBanner == false)
        {
			NoInternetFound();
 ...
 * */		// Activate Scanning
			...
			// -->>>ScanUIScreen (); // no need for scanUi script
...
*/
    ...
    public void SignInAndSignUpScreen()
    {
        GameObject SignInandSignUpPrefab = Resources.Load ("UIElements/SignInandSignUp") as GameObject;
        Instantiate (SignInandSignUpPrefab);
        Debug.Log("Instantiated login scree NOWWWWWWWWWW!!!!!!!!!!!!!!!!!!!!");
        DestroyScanUICloneObject ();
    }
    
    private void DestroyScanUICloneObject ()
    {
         Destroy (GameObject.FindWithTag("ScanUI"));
    }
