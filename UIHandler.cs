...
public class UIHandler : MonoBehaviour {
    ...
    private bool ScanUILoaded = false;
...
/******************************************************************************************************************
 * 
 * */		// Activate Scanning!! here commented
			LoadScanUIScreen ();
            DebugLog("scan Ui screen Loaded");
...
//	}
	...
	public void ShowInternetFoundDone()
	{
       ...
       public void LoadScanUIScreen ()
    {
        if(!ScanUILoaded)
        {
            
            GameObject ScanUIPrefab = Resources.Load ("UIElements/ScanUI") as GameObject;
            Instantiate (ScanUIPrefab);
            Debug.Log("Instantiated login scree NOWWWWWWWWWW!!!!!!!!!!!!!!!!!!!!");
            ScanUILoaded = true;
            DestroySignInAndSignUpCloneObject ();
        }
    }
    
    private void DestroySignInAndSignUpCloneObject ()
    {
         Destroy (GameObject.FindWithTag("SignInAndSignUp"));
    }
    
    public void SignOutSetBoolScanUItoFalse ()
    {
        ScanUILoaded = false;
    }
